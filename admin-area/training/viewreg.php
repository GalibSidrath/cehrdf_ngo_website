            ...
            <div class="card-body p-4">
                ...
                <table class="table table-hover align-middle" id="registrationsTable">
                    ...
                    <tbody>
                        <?php
                        // Query to fetch data
                        $query = "SELECT id, name, email, phone, educational_qualification, training_title, reg_date FROM training_reg WHERE 1";
                        ...
                        if ($result && mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($row['educational_qualification']); ?></td>
                                    <td><span
                                            class="badge bg-info"><?php echo htmlspecialchars($row['training_title']); ?></span>
                                    </td>
                            ...
                            echo '<tr><td colspan="7" class="text-center">No registrations found yet.</td></tr>';
                        }
                        ?>
                    </tbody>
                </table>
